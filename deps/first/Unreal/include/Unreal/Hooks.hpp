...
namespace RC::Unreal
{
    ...
    namespace Hook
    {
        ...
        struct RC_UE_API StaticStorage
        {
            ...
            static std::unique_ptr<::PLH::x64Detour> LoadMapDetour;
            ...
            static std::vector<LoadMapCallback> LoadMapPreCallbacks;
            static std::vector<LoadMapCallback> LoadMapPostCallbacks;
        ...
        auto RC_UE_API RegisterLoadMapPreCallback(LoadMapCallback) -> void;
        auto RC_UE_API RegisterLoadMapPostCallback(LoadMapCallback) -> void;
