...
namespace RC::Unreal
{
    ...
    public:
        ...
        virtual void UObjectArray_Lock() = 0;
        virtual void UObjectArray_Unlock() = 0;
        // GUObjectArray -> END
    ...
    public:
        ...
        struct FUObjectArray
        {
            ...
            Windows::CRITICAL_SECTION ObjObjectsCritical;                                               // 0x18
    ...
    public:
        ...
        {
            m_guobjectarray_internal->UObjectCreateListeners.RemoveSingle(Listener);
        }
        ...
        {
            m_guobjectarray_internal->UObjectDeleteListeners.RemoveSingle(Listener);
        }

        void UObjectArray_Lock() override;
        void UObjectArray_Unlock() override;
        // GUObjectArray -> END
    };
}
