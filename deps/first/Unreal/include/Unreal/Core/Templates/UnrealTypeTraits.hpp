...
/*=============================================================================
	UnrealTypeTraits.hpp: Unreal type traits definitions.
...
#include "Unreal/Core/Templates/RemoveCV.hpp"
...
namespace RC::Unreal
{
    ...
    template <int32_t N, typename... Types>
    struct TNthTypeFromParameterPack;

    template <int32_t N, typename T, typename... OtherTypes>
