...
std::function<void(UObject*, FFrame*, void*)>*& UFunction::GetFunc()
{
    ...
    return *Helper::Casting::ptr_cast<std::function<void(UObject*, FFrame*, void*)>**>(this, offset->second);
}
const std::function<void(UObject*, FFrame*, void*)>*& UFunction::GetFunc() const
{
    static auto offset = MemberOffsets.find(STR("Func"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UFunction::Func' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const std::function<void(UObject*, FFrame*, void*)>**>(this, offset->second);
}
