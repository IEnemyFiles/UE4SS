...
public:
    TMap<enum EMouseCursor::Type, TSharedPtr<SWidget,1>>& GetCursorWidgets();
    const TMap<enum EMouseCursor::Type, TSharedPtr<SWidget,1>>& GetCursorWidgets() const;
...
public:
    TMap<FName, void *>& GetHardwareCursorCache();
    const TMap<FName, void *>& GetHardwareCursorCache() const;

public:
    TMap<enum EMouseCursor::Type, void *>& GetHardwareCursors();
    const TMap<enum EMouseCursor::Type, void *>& GetHardwareCursors() const;
