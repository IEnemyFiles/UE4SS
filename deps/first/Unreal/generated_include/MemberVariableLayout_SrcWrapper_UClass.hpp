...
std::function<void(UObject*, void*)>*& UClass::GetClassAddReferencedObjects()
{
    ...
    return *Helper::Casting::ptr_cast<std::function<void(UObject*, void*)>**>(this, offset->second);
}
const std::function<void(UObject*, void*)>*& UClass::GetClassAddReferencedObjects() const
{
    static auto offset = MemberOffsets.find(STR("ClassAddReferencedObjects"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::ClassAddReferencedObjects' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const std::function<void(UObject*, void*)>**>(this, offset->second);
}
...
std::function<void(void*)>*& UClass::GetClassConstructor()
{
    ...
    return *Helper::Casting::ptr_cast<std::function<void(void*)>**>(this, offset->second);
}
const std::function<void(void*)>*& UClass::GetClassConstructor() const
{
    static auto offset = MemberOffsets.find(STR("ClassConstructor"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::ClassConstructor' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const std::function<void(void*)>**>(this, offset->second);
}
...
std::function<UObject*(void*)>*& UClass::GetClassVTableHelperCtorCaller()
{
    ...
    return *Helper::Casting::ptr_cast<std::function<UObject*(void*)>**>(this, offset->second);
}
const std::function<UObject*(void*)>*& UClass::GetClassVTableHelperCtorCaller() const
{
    static auto offset = MemberOffsets.find(STR("ClassVTableHelperCtorCaller"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::ClassVTableHelperCtorCaller' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const std::function<UObject*(void*)>**>(this, offset->second);
}
...
TMap<FName, UFunction *>& UClass::GetFuncMap()
{
    static auto offset = MemberOffsets.find(STR("FuncMap"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::FuncMap' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<TMap<FName, UFunction *>*>(this, offset->second);
}
const TMap<FName, UFunction *>& UClass::GetFuncMap() const
{
    static auto offset = MemberOffsets.find(STR("FuncMap"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::FuncMap' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const TMap<FName, UFunction *>*>(this, offset->second);
}

TMap<FName, UFunction *>& UClass::GetInterfaceFuncMap()
{
    static auto offset = MemberOffsets.find(STR("InterfaceFuncMap"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::InterfaceFuncMap' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<TMap<FName, UFunction *>*>(this, offset->second);
}
...
{
    static auto offset = MemberOffsets.find(STR("ParentFuncMap"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::ParentFuncMap' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<TMap<FName, UFunction *>*>(this, offset->second);
}
...
{
    static auto offset = MemberOffsets.find(STR("SuperFuncMap"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UClass::SuperFuncMap' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<TMap<FName, UFunction *>*>(this, offset->second);
}
