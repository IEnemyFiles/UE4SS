...
TMap<enum EMouseCursor::Type, TSharedPtr<SWidget,1>>& UGameViewportClient::GetCursorWidgets()
{
    static auto offset = MemberOffsets.find(STR("CursorWidgets"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UGameViewportClient::CursorWidgets' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<TMap<enum EMouseCursor::Type, TSharedPtr<SWidget,1>>*>(this, offset->second);
}
const TMap<enum EMouseCursor::Type, TSharedPtr<SWidget,1>>& UGameViewportClient::GetCursorWidgets() const
{
    static auto offset = MemberOffsets.find(STR("CursorWidgets"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UGameViewportClient::CursorWidgets' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const TMap<enum EMouseCursor::Type, TSharedPtr<SWidget,1>>*>(this, offset->second);
}
...
TMap<FName, void *>& UGameViewportClient::GetHardwareCursorCache()
{
    static auto offset = MemberOffsets.find(STR("HardwareCursorCache"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UGameViewportClient::HardwareCursorCache' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<TMap<FName, void *>*>(this, offset->second);
}
const TMap<FName, void *>& UGameViewportClient::GetHardwareCursorCache() const
{
    static auto offset = MemberOffsets.find(STR("HardwareCursorCache"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UGameViewportClient::HardwareCursorCache' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const TMap<FName, void *>*>(this, offset->second);
}

TMap<enum EMouseCursor::Type, void *>& UGameViewportClient::GetHardwareCursors()
{
    static auto offset = MemberOffsets.find(STR("HardwareCursors"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UGameViewportClient::HardwareCursors' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<TMap<enum EMouseCursor::Type, void *>*>(this, offset->second);
}
const TMap<enum EMouseCursor::Type, void *>& UGameViewportClient::GetHardwareCursors() const
{
    static auto offset = MemberOffsets.find(STR("HardwareCursors"));
    if (offset == MemberOffsets.end()) { throw std::runtime_error{"Tried getting member variable 'UGameViewportClient::HardwareCursors' that doesn't exist in this engine version."}; }
    return *Helper::Casting::ptr_cast<const TMap<enum EMouseCursor::Type, void *>*>(this, offset->second);
}
