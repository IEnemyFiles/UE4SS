...
public:
    ...
    const double& GetAudioTimeSeconds() const;
...
public:
    ...
    const double& GetPauseDelay() const;
...
public:
    ...
    const double& GetRealTimeSeconds() const;
...
public:
    ...
    const double& GetTimeSeconds() const;
...
public:
    ...
    const double& GetUnpausedTimeSeconds() const;
...
public:
    uint8& GetbHasEverBeenInitialized();
    const uint8& GetbHasEverBeenInitialized() const;
